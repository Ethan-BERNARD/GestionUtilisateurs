...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 13 mai 2026 à 10:27
...
--
-- Structure de la table `utilisateurautorise`
--

CREATE TABLE `utilisateurautorise` (
  `id` int NOT NULL,
  `identifiantUtil` varchar(32) NOT NULL,
  `mdp` varchar(255) NOT NULL,
  `role` varchar(32) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Déchargement des données de la table `utilisateurautorise`
--

INSERT INTO `utilisateurautorise` (`id`, `identifiantUtil`, `mdp`, `role`) VALUES
(1, 'admin', '1234', 'ADMIN'),
(2, 'claude', 'SecretPass', 'RH');
...
('a131', 'Villachane', 'Louis', 'lvillachane', 'jux7g', '8 rue des Charmes', '46001', 'Cahors', '2005-12-21'),
('a17', 'Andre', 'David', 'dandre', 'oppg5', '1 rue Petit', '46200', 'Lalbenque', '1998-11-23'),
('a55', 'Bedos', 'Christiane', 'cbedos1', 'gmhxd', '1 rue Peranud', '46250', 'Montcuq', '1995-01-12'),
...
('c3', 'Des', 'Philippe', 'pdes', 'gk9kx', '13 rue Barthes', '94000', 'Créteil', '2010-12-14'),
...
('e22', 'Desmarquest', 'Nathalie', 'ndesmarquest', 'f1fob', '14 Place d Arc', '45000', 'Orléans', '2007-11-13'),
...
('f212', 'testd', 'testd', 'testd', 'testd', 'testd', 'testd', 'testd', '2001-11-11'),
...
('f58', 'Lebond', 'Luka', 'llebond1', '0fce5', '19 Espace de la grue', '29910', 'Concarneau', '2025-09-10'),
('f97', 'Jeane', 'Marie', 'mjeane', '45b96', '18 rue des gares', '29171', 'fouesnant', '2025-11-12'),
('f99', 'Jean', 'Marie', 'mjean', '96467', '18 rue de la gare', '29170', 'fouesnant', '2025-11-12'),
('t55', 'uffa', 'dela', 'duffa', '1153c', '15refer', '18225', 'ggduli', '2025-10-08');
...
--
-- Index pour la table `utilisateurautorise`
--
ALTER TABLE `utilisateurautorise`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `utilisateurautorise`
--
ALTER TABLE `utilisateurautorise`
